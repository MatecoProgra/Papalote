...
int WindowsDirectives() {
    ...
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:FILE_MAP_READ:PropertyInfo:size=%llu\n", ((unsigned long long)sizeof(FILE_MAP_READ)));
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:FILE_MAP_READ:PropertyInfo:signedness=$%s$\n", ((FILE_MAP_READ>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:FILE_MAP_READ:PropertyInfo:value=%llX\n", ((unsigned long long)FILE_MAP_READ));
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:FILE_MAP_WRITE:PropertyInfo:size=%llu\n", ((unsigned long long)sizeof(FILE_MAP_WRITE)));
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:FILE_MAP_WRITE:PropertyInfo:signedness=$%s$\n", ((FILE_MAP_WRITE>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:FILE_MAP_WRITE:PropertyInfo:value=%llX\n", ((unsigned long long)FILE_MAP_WRITE));
