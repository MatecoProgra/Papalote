...
#include "D:\progra\graal\lib\svm\clibraries\include\amd64cpufeatures.h"
...
int AMD64LibCHelperDirectives() {
    ...
    printf("NativeCodeInfo:AMD64LibCHelperDirectives:StructInfo:CPUFeatures:StructFieldInfo:fAVX_IFMA:PropertyInfo:size=%llu\n", ((unsigned long long)sizeof(((CPUFeatures *) 0)->fAVX_IFMA)));
    printf("NativeCodeInfo:AMD64LibCHelperDirectives:StructInfo:CPUFeatures:StructFieldInfo:fAVX_IFMA:PropertyInfo:offset=%llu\n", ((unsigned long long)offsetof(CPUFeatures, fAVX_IFMA)));
    {
        int is_unsigned;
        unsigned long long all_bits_set = -1;
        CPUFeatures fieldHolder;
